...
public class WeightedChance<T> implements WeightedObject<T> {
	...
	public static final double COMMON = 7.5;
	public static final double UNCOMMON = 3.5;
	public static final double RARE = 1.0;
	public static final double VERY_RARE = .50;
	public static final double LEGENDARY = 0.25;//0.50% Chance?
