...
public class Constants {
	...
	public static final int[] BLOCKED_DOORS = {
		26502, 26503, 26504, 26505, 24306, 24309, 26760,26461, 4799, 7129
	};
	 ...
	 * 
	 */
	public static final String VOTE_LINK = "http://www.SkyScapeLive.everythingrs.com/services/vote";
	public static final String STORE_LINK = "http://www.SkyScapeLive.everythingrs.com/services/store";
	public static final String FORUM_LINK = "http://www.SkyScapeLive.com";
	public static final String HISCORE_LINK = "http://SkyScapeLive.everythingrs.com/services/hiscores";
	public static final String UPDATE_LINK = "http://www.SkyScapeLive.com/forums/index.php?/forum/9-development-blogs/";
	public static final String RS_ADV = "https://www.rune-server.ee/runescape-development/rs2-server/advertise/672224-beta-access-upcoming-server-SkyScapeLive.html";
