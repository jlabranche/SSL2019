...
public class PlayerCombatInterface implements CombatInterface {
    ...
    public boolean canAttack() {
        ...
        if (attacking.isNpc()) {
            ...
            if(mob.getId() == 7554) {
           	 if(player.getRaids().raidLeader.getRaids().leftHand == false || player.getRaids().raidLeader.getRaids().leftHand == false ) {
           		 player.sendMessage("@red@You have to destroy both of Great Olm's hands first.");
           		 return false;
           	 }
              }
