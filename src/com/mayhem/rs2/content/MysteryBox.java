...
public class MysteryBox {
	...
	public static Chance<Item> LOOTS = new Chance<Item>(Arrays.asList(
			//Common Items
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(20199, 1)), //monk's robe top (g)
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(20202, 1)), //monk's robe(g)
			...
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(392, 550)), //Manta ray
			new WeightedChance<Item>(WeightedChance.COMMON, new Item(11937, 250)), //Dark crab
			...
			//Uncommon Items
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(2613, 1)), //rune platebody (g)
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(2615, 1)), //rune legs (g)
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(2617, 1)), //rune helm (g)
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(2617, 1)), //rune kite (g)
			...
			//Rare Items
			new WeightedChance<Item>(WeightedChance.RARE, new Item(2591, 1)), //black platebody (g)
			new WeightedChance<Item>(WeightedChance.RARE, new Item(2593, 1)), //black platelegs (g)
			new WeightedChance<Item>(WeightedChance.RARE, new Item(2595, 1)), //black full helm (g)
			new WeightedChance<Item>(WeightedChance.RARE, new Item(2597, 1)), //black kiteshield (g)
