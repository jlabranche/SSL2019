...
public class TutorialNpc extends Dialogue {
	...
	public void execute() {
		...
		case 0:
			DialogueManager.sendNpcChat(player, GUIDE, Emotion.HAPPY_TALK, "Hello @blu@" + player.getUsername() + "</col>, Welcome to SkyScapeLive!", "Would you like a quick tour of our home area?");
			next++;
			break;
		case 1:
		...
		case 22:
			...
			break;
		case 23:
			nChat(new String[] { "Check out our forums (@red@www.SkyScapeLive.com</col>)", "Make sure to vote to keep the server active." });
			break;
		case 24:
