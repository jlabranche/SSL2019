...
public class MembershipDialogue extends Dialogue {
	...
	public boolean clickButton(int id) {
		...
		case DialogueConstants.OPTIONS_5_2:
			player.send(new SendString("http://www.SkyScapeLive.com", 12000));
			break;
	...
	public void execute() {
		...
		case 0:
			...
			break;
		case 1:
			DialogueManager.sendOption(player, "What are SkyScapeLive Credits?", "Benifits of membership", "I have purchased something", "Update rank", "Nevermind");
			break;
		case 2:
			DialogueManager.sendNpcChat(player, 7042, Emotion.DEFAULT, "SkyScapeLive Credits can be purchased on our online store.", "They can be used for buying items from my store ", "and many other features in game.", "Including purchasing SkyScapeLive Credits in the Shops tab.");
			setNext(1);
			break;
		case 3:
