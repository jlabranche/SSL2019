...
public class WildermanBank {
    public Player player;
    public List<Item> items;

    public boolean viewingBank = false;
    public boolean addingItems = false;

    public int selectedItem = -1;
    public int selectedSlot = -1;

    public WildermanBank(Player player) {
        this.player = player;
        items = new ArrayList<>();
    }
    ...
    public void addItemToBank(int id, int amount) {
