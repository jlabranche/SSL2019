...
public class DonorChest {
	...
	public static Chance<Item> DONORCHEST = new Chance<Item>(Arrays.asList(
			...
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(10336, 1)),
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(10338, 1)),
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(10340, 1)),
			...
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(13307, 100000)),//blood money
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(995, Utility.randomNumber(25000000))),//coins
			...
			new WeightedChance<Item>(WeightedChance.RARE, new Item(12926, 1)),
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(12904, 1)),
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(13199, 1)),
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(13197, 1)),
			new WeightedChance<Item>(WeightedChance.LEGENDARY, new Item(11802, 1)),
			new WeightedChance<Item>(WeightedChance.RARE, new Item(11832, 1)),
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(11834, 1))
