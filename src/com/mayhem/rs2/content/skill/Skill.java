...
public class Skill {
	...
	public void addCombatExperience(CombatTypes type, int hit) {
		...
		case MELEE:
			...
			case AGGRESSIVE:
				...
				break;
			case CONTROLLED:
				addExperience(0, (exp / 3) * meleeExp);
				addExperience(2, (exp / 3) * meleeExp);
				addExperience(1, (exp / 3) * meleeExp);
				break;
			case DEFENSIVE:
		...
		case RANGED:
			...
			case CONTROLLED:
				...
				break;
			case DEFENSIVE:
				addExperience(4, exp / 2 * rangeExp);
				addExperience(1, exp / 2 * rangeExp);
				break;
			}
			break;
		}
	...
	public double addExperience(int id, double experience) {
		...
		if (player.isExtreme()) {
			...
			experience = experience * Skills.EXPERIENCE_RATES[id] * 1;
		}
	...
	public void onLevelup(int lvl, int skill) {
		...
		if ((skill != 4) && (skill != 14) && (skill != 17) && (skill != 19)&& (skill != 21)&& (skill != 22)) {
