...
public class TeleportHandler {
	...
	public enum TeleportationData {
		...
		REVENANTS(246081, "Hybrid pk", "Pk gear", "40", 0, new Location(3126, 3833, 0), false, false),
		/** Player Vs Monster */
		...
		THERMO(250068, "None", "High combat", "Instanced", 318, new Location(2368, 9449, 0), true, true),
		...
		INFERNO(254034, "None", "None", "None", 0, new Location(2495, 5103, 0), false, false),
		RAIDS(254035, "None", "None", "None", 0, new Location(1234, 3565, 0), false, false),
		/** Cities */
	...
	public static boolean specialCase(Player player, int buttonId) {
		...
		case 250058://Kraken
			...
			TaskQueue.queue(new Task(5) {
				@Override
				public void execute() {
					int[][] DATA = { { 493, 2276, 10038 }, { 493, 2276, 10034 }, { 493, 2284, 10034 }, { 493, 2284, 10038 }, { 496, 2278, 10035 } };
