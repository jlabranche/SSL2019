 ...
 *
 */
public class FashionScapeChest {
	/**
	 * casket Identification
	 */
	private final static Item CHEST = new Item(11158);
	...
	public static Chance<Item> EXTREMEDONORCHEST = new Chance<Item>(Arrays.asList(
			...
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(13271, 1)),//abyssal dagger
			new WeightedChance<Item>(WeightedChance.RARE, new Item(9067, 2)),//dream log		
			new WeightedChance<Item>(WeightedChance.RARE, new Item(19677, 2)),//ancient shard
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(19685, 1)),//dark totem
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(6051, 1)),//magic root
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(12603, 1)),//tyrannical ring
			new WeightedChance<Item>(WeightedChance.UNCOMMON, new Item(20784, 1)),//dragon claws
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(12817, 1)),//dragon claws
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(12821, 1)),//dragon claws
			new WeightedChance<Item>(WeightedChance.RARE, new Item(12825, 1)),//dragon claws
