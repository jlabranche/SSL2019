	...
	public static final class PlayerDetails {
		...
		public static boolean loadDetails(Player player) throws Exception {
			...
			try {
				...
				player.setRigour(details.rigour);
				player.setAugury(details.augury);
				
				player.raidCount=details.raids;
		...
		private final int rigour;
		private final int augury;
		...
		public PlayerDetails(Player player) {
			...
			rigour = player.getRigour();
			augury = player.getAugury();
			raids = player.raidCount;
