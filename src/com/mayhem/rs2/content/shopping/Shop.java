...
public class Shop extends ItemContainer {
	...
	public void buy(Player player, int slot, int id, int amount) {
		...
		if (amount > 10000) {
			player.getClient().queueOutgoingPacket(new SendMessage("[" + ShopConstants.COLOUR + "*</col>] You can only buy 10K maximum at a time from these shops."));
			amount = 10000;
		}
	...
	public boolean sell(Player player, int id, int amount) {
		...
		if (amount > 10000) {
			player.getClient().queueOutgoingPacket(new SendMessage("[" + ShopConstants.COLOUR + "*</col>] You can only sell 10K at a time to these shops."));
			amount = 10000;
		}
