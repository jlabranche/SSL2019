...
public class ObjectManager {
	...
	public static void declare() {
		...
		//Yanille
		spawnWithObject(29152, 2609, 3088, 0, 10, 3);//Player owned shops
		
		//Trees for Moss Giants
		spawnWithObject(12655, 2613, 3084, 0, 10, 1);//Furance
		deleteAndRemoveClip(2575, 3086, 0);
		deleteAndRemoveClip(2572, 3085, 0);
		deleteAndRemoveClip(2577, 3085, 0);
		deleteAndRemoveClip(2579, 3083, 0);
		deleteAndRemoveClip(2575, 3081, 0);
		deleteAndRemoveClip(2578, 3081, 0);
		deleteAndRemoveClip(2576, 3079, 0);
		deleteAndRemoveClip(2574, 3079, 0);
		deleteAndRemoveClip(2573, 3081, 0);
		deleteAndRemoveClip(2573, 3076, 0);
		deleteAndRemoveClip(2580, 3078, 0);
		deleteAndRemoveClip(2575, 3095, 0);
		deleteAndRemoveClip(2578, 3096, 0);
		deleteAndRemoveClip(2573, 3093, 0);
		deleteAndRemoveClip(2576, 3101, 0);
		deleteAndRemoveClip(2614, 3084, 0);
		deleteAndRemoveClip(2616, 3080, 0);
		deleteAndRemoveClip(2614, 3078, 0);
		deleteAndRemoveClip(2613, 3077, 0);
		deleteAndRemoveClip(2611, 3080, 0);
		deleteAndRemoveClip(2610, 3081, 0);
		deleteAndRemoveClip(2610, 3080, 0);
		deleteAndRemoveClip(2579, 3101, 0);
		deleteAndRemoveClip(2579, 3102, 0);
		deleteAndRemoveClip(2579, 3103, 0);
		deleteAndRemoveClip(2579, 3104, 0);
		deleteAndRemoveClip(2579, 3105, 0);
		deleteAndRemoveClip(2579, 3106, 0);
		deleteAndRemoveClip(2580, 3101, 0);
		deleteAndRemoveClip(2581, 3101, 0);
		deleteAndRemoveClip(2582, 3101, 0);
		deleteAndRemoveClip(2583, 3101, 0);
		deleteAndRemoveClip(2584, 3101, 0);
		deleteAndRemoveClip(2585, 3101, 0);
		deleteAndRemoveClip(2580, 3102, 0);
		deleteAndRemoveClip(2581, 3102, 0);
		deleteAndRemoveClip(2582, 3102, 0);
		deleteAndRemoveClip(2583, 3102, 0);
		deleteAndRemoveClip(2584, 3102, 0);
		deleteAndRemoveClip(2585, 3102, 0);
		deleteAndRemoveClip(2580, 3103, 0);
		deleteAndRemoveClip(2581, 3103, 0);
		deleteAndRemoveClip(2582, 3103, 0);
		deleteAndRemoveClip(2583, 3103, 0);
		deleteAndRemoveClip(2584, 3103, 0);
		deleteAndRemoveClip(2585, 3103, 0);
		deleteAndRemoveClip(2580, 3104, 0);
		deleteAndRemoveClip(2581, 3104, 0);
		deleteAndRemoveClip(2582, 3104, 0);
		deleteAndRemoveClip(2583, 3104, 0);
		deleteAndRemoveClip(2584, 3104, 0);
		deleteAndRemoveClip(2585, 3104, 0);
		deleteAndRemoveClip(2580, 3105, 0);
		deleteAndRemoveClip(2581, 3105, 0);
		deleteAndRemoveClip(2582, 3105, 0);
		deleteAndRemoveClip(2583, 3105, 0);
		deleteAndRemoveClip(2584, 3105, 0);
		deleteAndRemoveClip(2585, 3105, 0);
		deleteAndRemoveClip(2580, 3106, 0);
		deleteAndRemoveClip(2581, 3106, 0);
		deleteAndRemoveClip(2582, 3106, 0);
		deleteAndRemoveClip(2583, 3106, 0);
		deleteAndRemoveClip(2584, 3106, 0);
		deleteAndRemoveClip(2585, 3106, 0);
		
		
		//slayer doors
		deleteAndRemoveClip(3426, 3555, 1);
		deleteAndRemoveClip(3427, 3555, 1);
		deleteAndRemoveClip(3445, 3554, 2);
		...
		//spawnWithObject(31923, 3097, 3512, 0, 10, 0);//Occult Altar
