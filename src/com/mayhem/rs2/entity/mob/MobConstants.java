...
public final class MobConstants {
	 ...
	 */
	private static String[] NON_AGGRESSIVE_NPCS = { "athanakos", "crystal demon", "crushing hand", "screaming banshee", "cave abomination", "night beast", "greater abyssal demon", "nechryarch", "crystal avansie", "crystal dragon", "cerberus", "zulrah", "saradomin wizard", "zamorak wizard", "man", "woman", "gnome", "dwarf", "cow", "guard", "goblin", "banker", "tzhaar-xil", "tzhaar-ket", "moss giant" };

	/**
	 * A list of mobs that don't follow
	 */
	private static final int[] NO_FOLLOW_MOBS = { 7553,7554,7555,7707,7710, 7706, 1457, 3943, 3847 };

	/**
	 * Undead Mobs
	 */
	private static final String[] UNDEAD_MOBS_NAMES = {
			"Aberrant spectre",
			"Ankou",
			"Banshee",
			"Crawling Hand",
	...
	/**
	 * Gets if the mob is undead.
	 *
	 * @param mob
	 * @return
	 */
	public static final boolean isUndead(Mob mob) {
		for (String i : UNDEAD_MOBS_NAMES) {
			if (mob.getDefinition().getName().contains(i)) {
				return true;
			}
		}
		return false;
