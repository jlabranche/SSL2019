...
public abstract class Entity implements CombatInterface {
	...
	public boolean inRaids() {
		return inArea(new Location(3210, 5137), new Location(3368, 5759), false);  //Raids
	}
	
	public boolean inRaidsMountain() {
		return inArea(new Location(1219, 3542), new Location(1259, 3577), false);
	}
	/**
	...
	public boolean inMultiArea() {
		...
		if (inGodwars() || inInferno() ||  inZulrah() || inCorp() || inKraken() || inWGGame() || inRaids()) {
			return true;
		}
		...
		return x >= 2333 && y >= 3687 && x <= 2362 && y <= 3717 || x > 3228 && x < 3258 && y > 10134 && y < 10188 || x >= 1680 && y >= 10090 && x <= 1710 && y <= 10110 || x >= 3306 && y >= 9364 && x <= 3332 && y <= 9392 || ((x >= 2956) && (y >= 3714) && (x <= 3006) && (y <= 3750)) || ((x <= 2049) && (y <= 5251) && (x >= 1980) && (y >= 5178)) || ((x >= 2893) && (y >= 4430) && (x <= 2934) && (y <= 4471)) || ((x >= 1761) && (y >= 5337) && (x <= 1780) && (y <= 5370)) || ((x >= 3029) && (x <= 3374) && (y >= 3759) && (y <= 3903)) || ((x >= 2250) && (x <= 2280) && (y >= 4670) && (y <= 4720)) || ((x >= 3198) && (x <= 3380) && (y >= 3904) && (y <= 3970)) || ((x >= 3191) && (x <= 3326) && (y >= 3510) && (y <= 3759)) || ((x >= 2987) && (x <= 3006) && (y >= 3912) && (y <= 3930)) || ((x >= 2245) && (x <= 2295) && (y >= 4675) && (y <= 4720)) || ((x >= 3006) && (x <= 3071) && (y >= 3602) && (y <= 3710)) || ((x >= 3134) && (x <= 3192) && (y >= 3519) && (y <= 3646)) || ((z > 0) && (x >= 3460) && (x <= 3545) && (y >= 3150) && (y <= 3267)) || ((x >= 2369) && (x <= 2425) && (y >= 5058) && (y <= 5122))|| ((x >= 3241) && (y >= 9353) && (x <= 3256) && (y <= 9378)) || ((x >= 2914) && (y >= 4359) && (x <= 2972) && (y <= 4412));
	}
    ...
    public boolean inKraken() {
		int x = location.getX();
		int y = location.getY();
        return (x > 2272 && x < 2289 && y > 10031 && y < 10041);
    }
