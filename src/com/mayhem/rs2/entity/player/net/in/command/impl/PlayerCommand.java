...
public class PlayerCommand implements Command {
	...
	public boolean handleCommand(Player player, CommandParser parser) throws Exception {
		...
		case "commandlist":
		case "commandslist":
			player.send(new SendString("SkyScapeLive Command List", 8144));
		...
		case "store":
		case "credits":
			player.send(new SendString("http://www.SkyScapeLive.everythingrs.com/services/store", 12000));
		...
		case "stats":
		case "highscores":
			player.send(new SendString("http://www.SkyScapeLive.everythingrs.com/services/hiscores", 12000));
