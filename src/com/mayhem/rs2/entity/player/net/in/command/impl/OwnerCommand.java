		...
		case "givemod":
			...
			case "givesupport":
				if (parser.hasNext()) {
					...
					World.sendGlobalMessage("</col>[ @dre@SkyScapeLive </col>] @dre@" + player.determineIcon(player) + " " + Utility.formatPlayerName(player.getUsername()) + " has just been promoted to Player Support! ");
