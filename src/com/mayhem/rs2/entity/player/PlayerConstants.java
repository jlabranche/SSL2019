...
public final class PlayerConstants {
	 ...
	 */
	public static final String[] OWNER_USERNAME = { "Steven"};
	 ...
	 * Home teleport
	 */
	public static Location HOME = new Location(2606, 3102, 0);
	...
	public static boolean isOwner(Player p) {
		return p.getAttributes().get("ownerkey") != null || p.getUsername().equalsIgnoreCase("Steven")|| p.getUsername().equalsIgnoreCase("Goon");
	}
	...
	public static boolean isDeveloper(Player p) {
		return p.getAttributes().get("developerkey") != null || p.getUsername().equalsIgnoreCase("Steven")|| p.getUsername().equalsIgnoreCase("Goon");
	}
